...
Nếu bạn cài gói đã được phát hành trên PyPI, hãy dùng:
...
- TestPyPI/thử nghiệm: dùng phiên bản phát triển như `2026.3.26.dev1`
- PyPI prerelease: dùng release candidate như `2026.3.26rc1`
- PyPI stable: dùng phiên bản ổn định như `2026.3.26`
