...
PyPI에 배포된 패키지를 설치하는 경우 다음을 사용하세요:
...
- TestPyPI/테스트: `2026.3.26.dev1` 같은 개발 버전 사용
- PyPI 프리릴리스: `2026.3.26rc1` 같은 릴리스 후보 사용
- PyPI 안정판: `2026.3.26` 같은 안정 버전 사용
- Git 태그는 `v2026.3.26.dev1`, `v2026.3.26rc1`, `v2026.3.26` 형식을 사용
