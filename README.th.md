...
> เซิร์ฟเวอร์สำหรับเรียกดูและสตรีมภาพยนตร์แบบ self-hosted ที่สร้างด้วย Flask, Waitress และ `ffmpeg` พร้อมการผสาน Plex แบบเลือกใช้สำหรับเส้นทางการเล่นที่เน้นความเข้ากันได้
...
- `on_demand_transcode`: เปิดใช้การแปลงรหัสแบบในตัวสำหรับ source container
