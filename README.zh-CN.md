...
- TestPyPI/测试：使用类似 `2026.3.26.dev1` 的开发版本
- PyPI 预发布：使用类似 `2026.3.26rc1` 的候选发布版本
- PyPI 稳定版：使用类似 `2026.3.26` 的稳定版本
- Git 标签应为 `v2026.3.26.dev1`、`v2026.3.26rc1` 和 `v2026.3.26`
